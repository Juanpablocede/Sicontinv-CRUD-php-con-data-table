...
<body>
  <div class="container card-table">
    ...
    <div class="row">
        ...
        <table id="ListarData" class="table table-hover">
          <thead>
          ...
          <?php
              ...
              while($resultados = pg_fetch_object($resultado))
              {
                echo "<tr>";
                      ...
                      correo=$resultados->correo&persona_contacto=$resultados->persona_contacto' name='update' id='update' class='glyphicon glyphicon-pencil btn btn-primary btn-xs update'></a></td>";
                  echo "</tr>";
              }
          ?>
        </tbody>
